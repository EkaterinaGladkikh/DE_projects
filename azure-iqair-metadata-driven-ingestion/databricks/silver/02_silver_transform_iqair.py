...
pollution_raw = (
    base.select(
        ...
        "latitude", "longitude",
        "bronze_ingestion_ts",
        to_timestamp(get_json_object(col("raw_payload"), "$.data.current.pollution.ts"), "yyyy-MM-dd'T'HH:mm:ss.SSSX").alias("pollution_ts"),
...
weather_raw = (
    base.select(
        ...
        "latitude", "longitude",
        "bronze_ingestion_ts",
        to_timestamp(get_json_object(col("raw_payload"), "$.data.current.weather.ts"), "yyyy-MM-dd'T'HH:mm:ss.SSSX").alias("weather_ts"),
